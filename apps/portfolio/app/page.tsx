...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-br  dark:bg-black gray-200 transition-all duration-300">
      <div className="flex flex-col h-full p-8 gap-4">
        ...
        <div className="flex flex-col h-200 gap-6 text-white rounded-xl contain-content">
      ...
      <footer className="h40 min-w-full bg-black">
