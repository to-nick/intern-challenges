...
return(
    <main className="min-h-screen min-w-screen flex flex-col bg-gradient-to-br dark:from-black dark:via-gray-700 dark:to-gray-500 from-white via-gray-200 to-gray-500 transition-all duration-300 ">
        <div className="flex flex-col ml-10 mr-10 gap-10">
            <div className="ml-auto p-4">
                <ThemeToggle></ThemeToggle>
            </div>
            <h1 className='dark:text-gray-200 text-[clamp(2rem,4vw,3rem)]'>Projects</h1>
            <div className="flex gap-10 border-4 border-black dark:border-gray-200 rounded-xl p-4">
                <div className="w-1/3">
                    <img src={GWQImage.src} alt="" />
                </div>
                <article className="w-2/3 flex flex-col gap-4 items-center justify-center">
